...
dir = dir.create(tableLocation, showWarnings = F, recursive = T, mode = "0777")
save(PlatformMat, file = paste(dir,"PlatformMat.rda",sep="")) #please add a way to put this in the package data storing
}