...
load("PlatformAndAssociatedData_WebSites3.RData")
setwd("~/Desktop/TCGAbiolinks/data")
save(PlatformAndAssociatedData, file ="PlatformAndAssociatedData.RData")
...
BRCA_methylation27 <- TCGADownload(Tumor, Type, Species, PlatformAndAssociatedData, downloadFolder,PlatformType, nsample = 3)

PlatformType <- "humanmethylation450" # work
BRCA_methylation450 <- TCGADownload(Tumor, Type, Species, PlatformAndAssociatedData, downloadFolder,PlatformType, nsample = 3)
...
BRCA_hiseq_mirnaseq <- TCGADownload(Tumor, Type, Species, PlatformAndAssociatedData, downloadFolder,PlatformType, nsample = 3)
...
BRCA_genome_wide_snp_6 <- TCGADownload(Tumor, Type, Species, PlatformAndAssociatedData, downloadFolder,PlatformType, nsample = 3)

Species <- "CNV (Low Pass DNASeq)"
PlatformType <- "illuminahiseq_dnaseqc"  # to check
BRCA_hiseq_dnaseqc <- TCGADownload(Tumor, Type, Species, PlatformAndAssociatedData, downloadFolder,PlatformType, nsample = 3)
...
BRCA_protein <- TCGADownload(Tumor, Type, Species, PlatformAndAssociatedData, downloadFolder,PlatformType, nsample = 3)
...
BRCA_mutation <- TCGADownload(Tumor, Type, Species, PlatformAndAssociatedData, downloadFolder,PlatformType, nsample = 3)
