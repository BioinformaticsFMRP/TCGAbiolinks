...
TCGADownload(query, path = "dataBrca", type = "gene.quantification",samples = listSamples$IlluminaHiSeq_RNASeq[1:5])

# Download a list of barcodes with platform IlluminaHiSeq_RNASeqV2
by the way we received feedback from bioconductor and we moved all data output from 
