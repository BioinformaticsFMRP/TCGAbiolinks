...
You can easily read your downloaded data using the `TCGAPrepare` function.
This function will prepare data matrices for downstream analysis.
...
# samples from IlluminaHiSeq_RNASeqV2 with type rsem.genes.results
# samples to normalize later
TCGAPrepare(query, dir = "data", save = TRUE, filename = "myfile.rda")
```
