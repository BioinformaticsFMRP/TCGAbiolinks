...
tabBRCA <- str(querySamples)

knitr::kable(tabBRCA, digits = 2, caption = "Table common samples among platforms from TCGAQuery", row.names = TRUE)
```
\newpage
...
## TCGA query clinic data
 
```{r, eval = FALSE}
bar <- c("TCGA-G9-6378-02A-11R-1789-07",  "TCGA-CH-5767-04A-11R-1789-07",  
              "TCGA-G9-6332-60A-11R-1789-07",  "TCGA-G9-6336-01A-11R-1789-07","TCGA-G9-6336-11A-11R-1789-07",
              "TCGA-G9-7336-11A-11R-1789-07","TCGA-G9-7336-04A-11R-1789-07","TCGA-G9-7336-14A-11R-1789-07",
              "TCGA-G9-7036-04A-11R-1789-07","TCGA-G9-7036-02A-11R-1789-07","TCGA-G9-7036-11A-11R-1789-07",
              "TCGA-G9-7036-03A-11R-1789-07","TCGA-G9-7036-10A-11R-1789-07","TCGA-BH-A1ES-10A-11R-1789-07",
              "TCGA-BH-A1F010A-11R-1789-07", "TCGA-BH-A0BZ-02A-11R-1789-07","TCGA-B6-A0WY-04A-11R-1789-07",
              "TCGA-BH-A1FG-04A-11R-1789-08","TCGA-D8-A1JS-04A-11R-2089-08","TCGA-AN-A0FN-11A-11R-8789-08",
              "TCGA-AR-A2LQ-12A-11R-8799-08","TCGA-AR-A2LH-03A-11R-1789-07","TCGA-BH-A1F8-04A-11R-5789-07",
              "TCGA-AR-A24T-04A-55R-1789-07","TCGA-AO-A0J5-05A-11R-1789-07","TCGA-BH-A0B4-11A-12R-1789-07",
              "TCGA-B6-A1KN-60A-13R-1789-07","TCGA-AO-A0J5-01A-11R-1789-07","TCGA-AO-A0J5-01A-11R-1789-07",
              "TCGA-G9-6336-11A-11R-1789-07","TCGA-G9-6380-11A-11R-1789-07","TCGA-G9-6380-01A-11R-1789-07")

S<-SampleTypes(bar,"TP")

# Retrieve multi tissue types  NOT FROM THE SAME PATIENTS
SS<-MultiSampleTypes(bar,c("TP","NB"))

# Retrieve multi tissue types  FROM THE SAME PATIENTS
SSS<-MatchedCoupledSampleTypes(bar,c("NT","TP"))

clinic("gbm","clinical_patient")

clinic("acc","clinical_patient")

SampleTypes(bar,"TP")

CouplesSampleTypes(bar,"xx")

CouplesSampleTypes(bar,"TRBM_NBM")

MatchedSampleTypes(bar,"matched_TP_NT")
MatchedSampleTypes(bar,"matched_TR_NT")
MatchedSampleTypes(bar,"matched_TB_NB")
MatchedSampleTypes(bar,"matched_TRBM_NBM")
MatchedSampleTypes(bar,"XX")

stage_BRCA(bar,"xx")

stage_BRCA(bar,"stage_IIIA")

gender_BRCA(bar,"FEMALE")

ER_status_BRCA(bar,"Positive")

ER_status_BRCA(bar,"Negative")

ER_status_BRCA(bar,"Negfff")

PR_status_BRCA(bar,"Positive")

PR_status_BRCA(bar,"Negative")

PR_status_BRCA(bar,"Negfff")

HER_status_BRCA(bar,"Positive")

HER_status_BRCA(bar,"Negative")

HER_status_BRCA(bar,"Negfff")

d<-biospecimen("uvm","biospecimen_normal_control")
