...
## TCGA analyze (Preprocessing gene expression data)
...
# Example with TCGApreprocessing
...
```{r, fig.width=6, fig.height=4, echo=FALSE, fig.align="center"}
library(TCGAbiolinks)
tabSurvKMcompleteDEGs$pvalue <- format(as.numeric(tabSurvKMcompleteDEGs$pvalue), scientific = TRUE)
