...
* **consensusClusters**	One item returned from Concensus
* **labelCols**	Vector of columns to add to the heatpmap
* **cbPalette**	A list of colors, each one will be used in the labelCols
...
dataMut <- merge(dataMut,cluster, by.x="bcr_patient_barcode", by.y="Tumor_Sample_Barcode")
