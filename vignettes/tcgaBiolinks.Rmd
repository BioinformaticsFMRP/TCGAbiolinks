...
# [Gene Expression IlluminaHiSeq_RNASeq] TCGA query, download, prepare list of a barcode
...
# [Gene Expression IlluminaHiSeq_RNASeqV2] TCGA query, download, prepare list of a barcode
You can easily search TCGA samples, download and prepare a matrix of gene expression.
```{r, eval = FALSE}
