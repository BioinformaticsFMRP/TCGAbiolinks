...
We focused on the analysis of LGG samples. In particular, we used TCGA biolinks to download 293 samples with molecular subtypes. 
...
<<<<<<< HEAD
dataPrep <- TCGAanalyze_Preprocessing(path = pathCancer,
                                      object = dataAssy,
                                      cancer = cancer,
                                      cor.cut = 0.6)        # time = 13.028s
=======
```{r,eval=FALSE,echo=TRUE,message=FALSE,warning=FALSE}
...
TCGAvisualize_Heatmap(cancer = cancer,
                      DFfilt = datFilt,
                      DFclin = dataClin,
                      DFsubt = dataSubt,
...
Finally, we will take a look in the matation genes.
```{r,eval=FALSE,echo=TRUE,message=FALSE,warning=FALSE}
...
table(dataMut$groupsHC,dataMut$Variant_Classification)
table(dataMut$groupsHC,dataMut$Variant_Type)
...
<<<<<<< HEAD
<<<<<<< HEAD
TCGAvisualize_mutation(data = dataMut,
                       groupCol = "groupsHC",
                       geneList = "ATRX",
                       filename = "test.pdf",
                       by = "cluster",na.rm = TRUE)
df <- TCGAquery_subtype("lgg")
TCGAvisualize_profilePlot(df, 
                          groupCol = "RNASeqCluster", 
                          subtypeCol =  "IDH.1p19q.Subtype", 
...
strsplit(dataMut$ATRX[grep(",",dataMut$ATRX),])

dataMut2 <- dataMut
dataMut2$ATRX <- as.character(dataMut2$ATRX)
dataMut2[dataMut2$ATRX!="wt" & dataMut2$ATRX!="NA","ATRX"] <- "Mutation"


TCGAvisualize_profilePlot(dataMut, 
                          groupCol = "groupsHC", 
                          subtypeCol =  "IDH.1p19q.Subtype",
                          colors =  c("cyan","tomato","gold","gray"), 
                          na.rm = FALSE,
...
TCGAvisualize_profilePlot(dataMut, 
                          groupCol = "groupsHC", 
                          subtypeCol =  "MethylationCluster",
                          colors =  c("black","orchid3","palegreen4","sienna3", "steelblue4","gray"), 
                          na.rm = FALSE,
                          filename = "case2_Met.pdf")

TCGAvisualize_profilePlot(dataMut2, 
                          groupCol = "groupsHC", 
                          subtypeCol =  "ATRX",
                          na.rm = FALSE,
                          filename = "case2_ATRX.pdf")
