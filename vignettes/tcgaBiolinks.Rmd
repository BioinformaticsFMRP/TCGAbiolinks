...
## `GDCquery_clinic`: Working with clinical data.
...
This means this function is not parsing the XML files, we are also working in a function to
parse the XML to biotab.
...
|-----------------------------|-----------------------------------|-----------------|---------|
| Transcriptome Profiling     | Gene Expression Quantification    | HTSeq - Counts  | Working |
|                             |                                   | HTSeq - FPKM-UQ | Working |
|                             |                                   | HTSeq - FPKM    | Working |
|                             | Isoform Expression Quantification |                 |         |
|                             | miRNA Expression Quantification   |                 |         |
| Copy number variation       | Copy Number Segment               |                 | Working |
|                             | Masked Copy Number Segment        |                 | Working |
...
## Legacy data
| Data.category               	| Platform                            	| File extension 	| Status 	|
|-----------------------------	|-------------------------------------	|----------------	|--------	|
