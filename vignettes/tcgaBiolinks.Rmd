...
# Getting the data 
query <- TCGAQuery(tumor = "gbm", platform = "HumanMethylation450", level = 3)
TCGADownload(query,path="/Users/tiago/Desktop//biolinks")
data <- TCGAPrepare(query = query,dir = "/Users/tiago/Desktop/biolinks",save = T)
...
Using the clinical data, it is possible to create a
...
```{r, eval = FALSE}
data <- volcanoPlot(data, p.cut = 0.05, diffmean.cut = 0.15)
```
