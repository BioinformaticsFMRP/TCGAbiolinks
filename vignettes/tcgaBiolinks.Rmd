...
the `TCGAanalyze_Filtering` function. Also, iin order to classify your samples (barcode) 
...
## `TCGAanalyze_DEA` `&` `CreateTabLevel` Differential expression analysis (DEA)

Perform DEA (Differential expression analysis) to identify differentially expressed genes (DEGs) using the `TCGAanalyze_DEA` function. This function receives as parameters:
