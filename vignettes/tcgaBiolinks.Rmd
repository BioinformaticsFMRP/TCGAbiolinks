...
- id: ref7
  ...
  author: 
  - family: Noushmehr, H., Weisenberger, D.J., Diefes, K., Phillips, H.S., Pujara, K., Berman,
B.P., Pan, F., Pelloski, C.E., Sulman, E.P., Bhat, K.P. et al.
    given:
  journal: Cancer cell
  volume: 17
  number: 5
...
have data added. These subtypes will be automatically added in the summarizedExperiment
...
* **col.metadata: Dataframe with the col.label and rownames with patients ids
* **row.metadata: Dataframe with the row.label and rownames as genes 
(expression) or probes (methylation)
* **col.labels** Vector of columns to add to the heatpmap col labels
* **row.labels** Vector of columns to add to the heatpmap row labels
* **col.colors** A list of colors, aech one will be used in the labelCols
* **row.colors** A list of colors, aech one will be used in the labelRows
* **type** Select the colors of the heatmap values. Possible values are: 
"expression" (default), "methylation"
* **show_column_names** Show colnames names? Dafault: FALSE
...
TCGAvisualize_Heatmap(datFilt,
                      ...
                      col.colors =  list(
                          groupsHC = c("EC1"="black",
                                        ...
                                        "EC3"="blue",
                                        "EC4"="green3"),
                          histological_type=c("Astrocytoma"="cyan",
                                     "Oligoastrocytoma"="green3",
                                     "Oligodendroglioma"="red"),
                         IDH.1p19q.Subtype = c("IDHmut-codel"="tomato",
                                       "IDHmut-non-codel"="cyan",
                                       "IDHwt"="gold","NA"="white"),
                           CNCluster=c("C1"="purple",
                                       "C2"="green",
                                       "C3"="red",
                                       "NA"="white"),
                           COCCluster=c("coc1"="purple",
                                        "coc2"="green","coc3"="red"),
                           OncosignCluster= c("OSC1"="red","OSC2"="purple",
                                    "OSC3"="green","OSC4"="orange",
                                    "Unclassified"="gray","NA"="white")),
                      sortCol = "groupsHC",
