...
HumanMethylation450 platform. After we divided the data into two groups (primary and recurrent) in order to analyse the data. The final example is a volcano plot that compares the two groups.
