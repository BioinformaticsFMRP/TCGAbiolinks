...
dataSmTP <- TCGAquery_SampleTypes(lsSample$IlluminaHiSeq_RNASeqV2,"TP")
dataSmTN <- TCGAquery_SampleTypes(lsSample$IlluminaHiSeq_RNASeqV2,"NT")
dataClin <- TCGAquery_clinic("brca","clinical_patient")

            TCGAdownload(datQuery, path = pathCancer, type = dataType,
