...
dataSmTN <- TCGAquery_SampleTypes(barcode = lsSample$IlluminaHiSeq_RNASeqV2,
                                  typesample ="NT")[1:50]
dataClin <- TCGAquery_clinic(cancer = "brca",
...
dataNorm <- TCGAanalyze_Normalization(TCGA_RnaseqTable = dataPrep, 
                                      geneInfo,method = "gcContent")
dataFilt <- TCGAanalyze_Filtering(TableRnaseq = dataNorm,
                                QuantileThresh = 0.25)
