...
|-----------------------------|-----------------------------------|-----------------|-----------------------------------------------------------------------------|
| Transcriptome Profiling     | Gene Expression Quantification    | STAR - Counts  | Data frame or SE (losing 5% of information when mapping to genomic regions) |
...
|                             | Gene Level Copy Number      |                 | Returning only a dataframe for  the moment                                  |
