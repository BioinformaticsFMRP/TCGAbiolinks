...
##TCGAbatch_correction: Handle batch correction
...
batch.corrected.adjusted <- TCGAbatch_Correction(tabDF = dataFilt.tcga, batch.factor = "Plate", adjustment=c("TSS"))
```
