...
blueDEGs <- DEGsBlue[DEGsBlue$FDR < 0.01 & DEGsBlue$logFC >= 1, ]
blueDEGs <- blueDEGs[order(blueDEGs$FDR), ]
green3DEGs <- DEGsGreen3[DEGsGreen3$FDR < 0.01 & DEGsGreen3$logFC >= 1, ]
green3DEGs <- green3DEGs[order(green3DEGs$FDR), ]
redDEGs <- DEGsRed[DEGsRed$FDR < 0.01 & DEGsRed$logFC >= 1, ]
