...
#' # data will be saved in  GDCdata/legacy/Copy_number_variation/Copy_number_segmentation
...
#' # data will be saved in  example_data_dir/harmonized/Transcriptome_Profiling/miRNA_Expression_Quantification
