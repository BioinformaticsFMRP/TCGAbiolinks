####################################
### Claudia Cava and Catharina Olsen
### March 31, 2015
### All rights reserved
####################################
...
#clinical data BREAST CANCER STAGE
...
#clinical_patient_data<-read.delim("~/Dropbox/TCGAbiolinks/RScripts/Data_Type/nationwidechildrens.org_clinical_patient_brca.txt")
